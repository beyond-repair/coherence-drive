...
- Exact recursive Sierpiński spectral framework (N,E,Δ,λ_max,Tr(L^k) match the freeze at S2–S4)
...
- α=0.45 as a geometric angle
- 45°/0.45 numerical coincidence as physics
- α-threshold propulsion interpretation
- Hybrid ratio 0.795:1:1.993
- Undocumented amplification factors χ,η,D_eff(n)
...
- Self-similar w∝ℓ as an enhanced fractal sensor (sensor dies)
...
- Modified stress tensor as a derived ΔT_W (hook exists; not certified)
